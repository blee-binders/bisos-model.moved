...
*   =Sibling Panles=   :: [[elisp:(blee:bnsm:panel-goto "/bisos/panels/bisos/model/ICM")][ICM]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/panels/bisos/model/bisosProvisioning")][bisosProvisioning]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/panels/bisos/model/modelAndTerminology")][modelAndTerminology]] *|* 
...
** [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]     ~Siblings Links Of:~ ~bisosProvisioning~ 
...
** [[elisp:(show-all)][(>]] [[elisp:(blee:menu-sel:outline:popupMenu)][+-]] [[elisp:(blee:menu-sel:navigation:popupMenu)][==]]     ~Ancestor Links Of:~ ~bisosProvisioning~ 
...
####+BEGIN: blee:bxPanel:foldingSection :outLevel 2 :sep t :title "Stage 1:: /usr/local/bin" :anchor "" :extraInfo "pip install bisos.provision"
** /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/ 
** [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(org-cycle)][| /Stage 1:: /usr/local/bin:/ |]]  pip install bisos.provision  [[elisp:(org-shifttab)][<)]] E|
####+END

    bisos.provision requires bisos.bisos.bashStandaloneIcmSeed

    Creates:
       - /usr/local/bin/seedIcmStandalone.bash
       - /usr/local/bin/bisosProvision.sh

    /usr/local/bin/bisosProvision is very minial. It accomplishes the following:

       - It installs git
       - It configures git
       - It clones what is needed for Phase-2 in /opt/bisosProvision
       - Runs the rest from there.

    After that bin/bisosProvision is just an interfaces that 
    hides /opt/bisosProvision/gitRepos/provisioners from users.

####+BEGIN: blee:bxPanel:foldingSection :outLevel 2 :sep t :title "Stage 2:: /opt/bisosProvision/gitRepos/provisioners" :anchor "" :extraInfo "git clone"
** /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/ 
** [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(org-cycle)][| /Stage 2:: /opt/bisosProvision/gitRepos/provisioners:/ |]]  git clone  [[elisp:(org-shifttab)][<)]] E|
####+END

    /usr/local/bin/bisosProvision.sh then git clones /var/bisosProvision/gitRepos/provisioners
...
####+BEGIN: blee:bxPanel:foldingSection :outLevel 2 :sep t :title "Stage 3:: /bisos/core/bin" :anchor "" :extraInfo "with bisos/pip/pkgs"
** /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/ 
** [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(org-cycle)][| /Stage 3:: /bisos/core/bin:/ |]]  with bisos/pip/pkgs  [[elisp:(org-shifttab)][<)]] E|
####+END
