...
** [[elisp:(org-shifttab)][<)]] E|
####+END
####+BEGIN: blee:bxPanel:foldingSection :outLevel 1 :sep t :title "Provisioing Model" :anchor "" :extraInfo ""
* /[[elisp:(beginning-of-buffer)][|^]]  [[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]] [[elisp:(delete-other-windows)][|1]]/ 
* [[elisp:(show-all)][(>]]  _[[elisp:(blee:menu-sel:outline:popupMenu)][±]]_  _[[elisp:(blee:menu-sel:navigation:popupMenu)][Ξ]]_       [[elisp:(org-cycle)][| *Provisioing Model:* |]]    [[elisp:(org-shifttab)][<)]] E|
####+END
** 
** Model
*** Provisioning Model
...
*** Phase 1 -- pip install bisos.provision
    ...
    /usr/local/bin/bisosProvision is very minial. It accomplishes the following:
       ...
       - Runs what is needed from there.

    bin/bisosProvision is just an interfaces that hides gitRepos/provisioners from users.

      
*** Phase 2 -- /opt/bisosProvision/gitRepos/provisioners

    /usr/local/bin/bisosProvision then git clones /var/bisosProvision/gitRepos/provisioners
...
*** Phase 3 -- Obtain Needed BxOs

*** Phase 4 -- Configure And Run Services
