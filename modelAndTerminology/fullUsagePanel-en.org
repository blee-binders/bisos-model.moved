...
*   *Siblings*   :: [[elisp:(blee:bnsm:panel-goto "/bisos/git/auth/bxRepos/blee-binders/bisos-model/PP-hardware/_nodeBase_")][ =PP-hardware= ]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/git/auth/bxRepos/blee-binders/bisos-model/bisosAccts")][bisosAccts]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/git/auth/bxRepos/blee-binders/bisos-model/bisosProvisioning")][bisosProvisioning]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/git/auth/bxRepos/blee-binders/bisos-model/modelAndTerminology")][modelAndTerminology]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/git/auth/bxRepos/blee-binders/bisos-model/universalBisos")][universalBisos]] *|*
*   /Ancestors/  :: [[elisp:(blee:bnsm:panel-goto "/bisos/git/auth/bxRepos/blee-binders/bisos-model/_nodeBase_")][ =bisos-model= ]] *|* [[elisp:(blee:bnsm:panel-goto "/bisos/git/auth/bxRepos/blee-binders/_nodeBase_")][ =blee-binders= ]] *|*
...
**** Guest: A VM Guest
**** VM-Guest: A VM Guest
**** Pure-Host: A Host which does not support virtualization.
**** PureSys: Same as a Pure-Host
**** 
**** BxP: (BP) ByStar Platform -- Any Sys equipped with BISOS
...
**** BCP: BISOS Container Platform -- BP capable of containing BPOs
**** BSP: BISOS Site Platform -- A BP configured within a site
****
*** 
