...
**** bxe s are uniqly identified by oid and by registrar uniq entityName.
**** realized bxe have uname in repo which is same as entityName.
**** activated bxe is a bxo
**** bxo s have uname in bxp as account
