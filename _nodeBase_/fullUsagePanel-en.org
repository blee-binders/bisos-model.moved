...
####+END
** +
** Portable Facilities Capability  (PFC) = BPO + Facility Software
** Portable Service Capability (PSC) = BPO + Service Software
** B|
...
####+END
** +
** Possesion Assertable Libre-Halaal Service (PALS) = PSC + PAAI-Framework
** Possesion Assertable Autonomous Identity (PAAI) = PAAI-Framework + domainName + registrations
** B|
